      ...
      <>
          <Container className="text-center" fluid={true}>
            ...
            <div className="section-title text-center mb-55">
              <h2>NEW ARRIVAL &nbsp;
                <a className="btn btn-sm ml-2 site-btn" onClick={this.previous} > <FontAwesomeIcon icon={faArrowLeft} /></a> 
                &nbsp;
                <a className="btn btn-sm ml-2 site-btn" onClick={this.next} > <FontAwesomeIcon icon={faArrowRight} /></a>
              </h2>
